...
function get_xpopup(&$XPOPUP) {
	$XPOPUP = array(
		...
		'l' => array(
	        ...
	        '__cmd' => '[N|N1,N2,N3-N4] [COLOR]',
	        '__eg' => '2 $rgb(255,0,0)',
            '__notes' => array(
				'You can specify [v]default[/v] in [p]COLOR[/p] to reset it to the default value.',
				'[N] can be a range of colours 1,3-6,14 etc..',
			),
		),
        'm' => array(
                ...
                '__params' => array(
                    'COLORS' => array(
						...
						'__values' => array(
							...
							'12' => 'CheckBox Tick',
							'13' => 'CheckBox Frame',
							'14' => 'CheckBox Tick disabled',
							'15' => 'CheckBox Frame disabled',
							'16' => 'CheckBox Hot',
							'17' => 'CheckBox Tick Hot',
							'18' => 'CheckBox Frame Hot',
							'19' => 'Menu Border',
							'20' => 'Vertical Separator',
						),
					),
				),
	        '__notes' => array(
