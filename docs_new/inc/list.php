        ...
        'A' => array(
			...
			'__params' => array(
                ...
                '__args' => array(
                    ...
                    'H' => array(
						'__cmd' => '[HASHTABLE] [ITEM]',
						'__params' => array(
							'HASHTABLE' => 'The hashtable to load from.',
							'ITEM' => 'The hashtable item name to load.',
						),
					),
                    'n' => array(
						'__cmd' => '[HASHTABLE] [INDEX]',
						'__params' => array(
							'HASHTABLE' => 'The hashtable to load from.',
							'INDEX' => 'The hashtable item index to load.',
						),
					),
					't' => array(
