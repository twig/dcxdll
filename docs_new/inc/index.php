...
<div class="divpink" style="color: #0000ff; padding-top: 0px;">DCX v3.1+ only works on mIRC v7+, Try & use the latest mIRC if possible (v7.75 at the time of writing)</div>
...
<table style="table-layout: fixed;">
	...
	<tr>
		<td><a>Support</a></td>
		<td>
			<a href="irc://irc.genscripts.io/genscripts">#genscripts @ Genscripts</a>
		</td>
	</tr>
