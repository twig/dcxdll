...
function get_intro_howtocompile() {
	...
	<tr style="text-indent: 40px"><td>Detours installed. <a href='https://github.com/microsoft/Detours.git'>https://github.com/microsoft/Detours.git</a></td></tr>
	...
	<tr style="text-indent: 40px"><td>Git for windows installed.</td></tr>
...
<table class="tbl_tag_details">
    ...
    <tr>
	  <td class="tag"><code>&lt;DetoursDir&gt;$(SolutionDir)..\..\DetoursMain\&lt;/DetoursDir&gt;</code></td>
	  <td class="desc">Path to the Detours files.</td>
	</tr>
    <tr>
