...
//		'tooltips' => 'The listview will have a tooltip.',
		...
		'columnoverflow' => 'Indicates that an overflow button should be displayed in [s]icon[/s]/[s]tile[/s] view if there is not enough client width to display the complete set of header items. ([s]headeralways[/s] needed) ([s]icon[/s] & [s]smallicon[/s] view)',
		...
		'subitemsel' => 'Enable selecting subitems. (can\'t be used with [s]fullrow[/s])',
	...
	$XDID = array(
		'a' => array(
			...
			'__params' => array(
				...
				'+FLAGS' => array(
					...
					'__values' => array(
						...
						'w' => '[p](TEXT)[/p] is [+IFLAGS] [TABLE NAME] [N,N1-N2...|name]',
						'y' => '[p](TEXT)[/p] is [+IFLAGS] [@windowname] [N,N1-N2...]',
						'z' => '[p](TEXT)[/p] is [+IFLAGS] [DIALOG] [ID] (N,N1-N2...)',
					),
				),
			...
			'__notes' => array(
				...
				' [v]+[/v]   No Flags specified. [p]N,N1-N2[/p] numeric range supplied. Add all items in range.',
				'- [p]N[/p] must be > 0, can be supplied as a single number.',
				'- [p]N1[/p] must be > 0',
				'- [p]N2[/p] must be >= [p]N1[/p].',
				' [v]+a[/v]  item(s) contain all the flags & icon info etc.. for the item(s) to be added from [p]INDENT[/p] onwards.',
				' [v]+A[/v]  add all items starting at [p]N[/p] (can\'t be used with [f]+i[/f]).',
				' [v]+i[/v]  [p]name[/p] single named item to be added. (can\'t be used with [f]+A[/f], only applies to hashtables)',
			),
		),
		'A' => array(
