...
$CHANGES = array(
    ...
    'v1.4.1' => array(
        ...
        'Fixes and changes' => array(
			...
			'xpop - - changed /xpop -a to allow for tabs within label (but disables unimplemented \'command\' feature. it can still be implemented by using the mirc way of doing things and using : instead of tab)'
		),
        'DCX Project' => array(
