...
//		if (text[i] == 2 || text[i] == 3 || text[i] == 15 || text[i] == 22 || text[i] == 31) {
//			if (token.len()) {
//				this->insertText(token.to_chr(), bline, uline, bmcolor, mcolor, bbkgcolor, bkgcolor, 0);
//				token = "";
//			}
//		}
//		// if current char is a control code
//		switch (text[i])
//		{
//		case 2:	// CTRL+B Parsing
//			{
//				bline = !(bline);
//			}
//			break;
//		case 3:	// CTRL+K Parsing
//			{
//				if (text[i +1] >= '0' && text[i +1] <= '9') {
//					colbuf[0] = text[i +1];
//					colbuf[1] = '\0';
...
//			}
//			break;
//		case 15:	// CTRL+O Parsing
//			{
//				mcolor = -1;
//				bkgcolor = -1;
//			}
//		case 22:	// CTRL+R Parsing
//			{
//				bline = false;
//				uline = false;
//			}
//			break;
//		case 31:	// CTRL+U Parsing
//			{
//				uline = !(uline);
//			}
//			break;
